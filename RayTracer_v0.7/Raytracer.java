...
public class Raytracer {
    ...
    private static final double REFLECTION_BIAS = 0.0005;
    ...
    private Color traceRay(Scene scene, Ray ray, int depth) {
        ...
        Vector3D reflectionOrigin = intersection.getPosition().add(normal.multiply(REFLECTION_BIAS));
    ...
    private Color shade(Scene scene, Intersection intersection, Ray ray) {
        ...
        for (Light light : scene.getLights()) {
            // Computes the direction and distance falloff for the current light.
            ...
            double diffuse = nDotL * light.getIntensity() * falloff;
            ...
            double specular = Math.pow(
                ...
                shininess
            ) * specularStrength * light.getIntensity() * falloff;
    ...
    public static void main(String[] args) {
        ...
        // Adds a point light near the camera to create local highlights with visible falloff.
        scene.addLight(new PointLight(
            new Vector3D(-0.75, 1.35, 1.15),
            Color.WHITE,
            2.2,
            1.0,
            0.18,
        ...
        // Adds a warm point light near the spout to reveal curved details through falloff.
        scene.addLight(new PointLight(
            new Vector3D(1.5, 0.7, 0.65),
        ...
        // Adds a soft overhead point light to reveal the lid silhouette with limited reach.
        scene.addLight(new PointLight(
            new Vector3D(0.0, 1.6, 0.4),
